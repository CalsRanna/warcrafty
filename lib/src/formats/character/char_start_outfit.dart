...
/// CharStartOutfit 格式字符串
const String charStartOutfitFormat = 'dbbbXiiiiiiiiiiiiiiiiiiiiiiiixxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx';

/// CharStartOutfit 结构定义
const DbcStructureDefinition charStartOutfit = DbcStructureDefinition(
  name: 'CharStartOutfit',
  format: charStartOutfitFormat,
  fields: [
