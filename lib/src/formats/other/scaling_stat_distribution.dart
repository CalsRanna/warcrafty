/// ScalingStatDistribution.dbc - 缩放属性分布格式
library;
...
const String scalingStatDistributionFormat = 'niiiiiiiiiiiiiiiiiiiii';

/// ScalingStatDistribution 结构定义
const DbcStructureDefinition scalingStatDistribution = DbcStructureDefinition(
  name: 'ScalingStatDistribution',
  format: scalingStatDistributionFormat,
  fields: [
