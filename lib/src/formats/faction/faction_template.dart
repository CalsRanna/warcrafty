...
const String factionTemplateFormat = 'niiiiiiiiiiiii';

/// FactionTemplate 结构定义
const DbcStructureDefinition factionTemplate = DbcStructureDefinition(
  name: 'FactionTemplate',
  format: factionTemplateFormat,
  fields: [
