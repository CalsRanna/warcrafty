...
final lFGDungeons = DbcSchema(
  ...
  fields: [
    ...
    const Field(
      index: 21,
      name: 'Target_level_min',
      description: 'Target_level_min',
      type: FieldType.int32,
    ),
    const Field(
      index: 22,
      name: 'Target_level_max',
      description: 'Target_level_max',
      type: FieldType.int32,
    ),
    const Field(
      index: 23,
    ...
    const Field(
      ...
      description: 'TextureFilename',
      type: FieldType.string,
    ),
    const Field(
      index: 29,
      name: 'ExpansionLevel',
      description: 'ExpansionLevel',
      type: FieldType.int32,
    ),
    const Field(
      index: 30,
