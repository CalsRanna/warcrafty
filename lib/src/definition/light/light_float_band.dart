...
const lightFloatBand = DbcStructureDefinition(
  name: 'LightFloatBand',
  format: 'niiiiiiiiiiiiiiiiiffffffffffffffff',
  fields: [
    ...
    FieldDefinition(index: 18, name: 'Data0', description: 'Data 0', format: DbcFieldFormat.float),
    FieldDefinition(index: 19, name: 'Data1', description: 'Data 1', format: DbcFieldFormat.float),
    FieldDefinition(index: 20, name: 'Data2', description: 'Data 2', format: DbcFieldFormat.float),
    FieldDefinition(index: 21, name: 'Data3', description: 'Data 3', format: DbcFieldFormat.float),
    FieldDefinition(index: 22, name: 'Data4', description: 'Data 4', format: DbcFieldFormat.float),
    FieldDefinition(index: 23, name: 'Data5', description: 'Data 5', format: DbcFieldFormat.float),
    FieldDefinition(index: 24, name: 'Data6', description: 'Data 6', format: DbcFieldFormat.float),
    FieldDefinition(index: 25, name: 'Data7', description: 'Data 7', format: DbcFieldFormat.float),
    FieldDefinition(index: 26, name: 'Data8', description: 'Data 8', format: DbcFieldFormat.float),
    FieldDefinition(index: 27, name: 'Data9', description: 'Data 9', format: DbcFieldFormat.float),
    FieldDefinition(index: 28, name: 'Data10', description: 'Data 10', format: DbcFieldFormat.float),
    FieldDefinition(index: 29, name: 'Data11', description: 'Data 11', format: DbcFieldFormat.float),
    FieldDefinition(index: 30, name: 'Data12', description: 'Data 12', format: DbcFieldFormat.float),
    FieldDefinition(index: 31, name: 'Data13', description: 'Data 13', format: DbcFieldFormat.float),
    FieldDefinition(index: 32, name: 'Data14', description: 'Data 14', format: DbcFieldFormat.float),
    FieldDefinition(index: 33, name: 'Data15', description: 'Data 15', format: DbcFieldFormat.float),
  ],
);
