...
/// VehicleSeat 格式字符串
const String vehicleSeatFormat = 'niiffffffffffiiiiiifffffffiiifffiiiiiiiffiiiiixxxxxxxxxxxx';

/// VehicleSeat 结构定义
const DbcStructureDefinition vehicleSeat = DbcStructureDefinition(
  name: 'VehicleSeat',
  format: vehicleSeatFormat,
  fields: [
