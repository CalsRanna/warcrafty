...
/// GemProperties 格式字符串
const String gemPropertiesFormat = 'nixxi';

/// GemProperties 结构定义
const DbcStructureDefinition gemProperties = DbcStructureDefinition(
  name: 'GemProperties',
  format: gemPropertiesFormat,
  fields: [
