...
final itemRandomSuffix = DbcSchema(
  ...
  fields: [
    ...
    const Field(
      index: 24,
      name: 'AllocationPct0',
      description: 'AllocationPct 0',
      type: FieldType.int32,
    ),
    const Field(
      index: 25,
      name: 'AllocationPct1',
      description: 'AllocationPct 1',
      type: FieldType.int32,
    ),
    const Field(
      index: 26,
      name: 'AllocationPct2',
      description: 'AllocationPct 2',
      type: FieldType.int32,
    ),
    const Field(
      index: 27,
      name: 'AllocationPct3',
      description: 'AllocationPct 3',
      type: FieldType.int32,
    ),
    const Field(
      index: 28,
      name: 'AllocationPct4',
      description: 'AllocationPct 4',
      type: FieldType.int32,
    ),
  ],
);
