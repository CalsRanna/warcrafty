...
const String creatureFamilyFormat = 'nfifiiiiixssssssssssssssssxx';

/// CreatureFamily 结构定义
const DbcStructureDefinition creatureFamily = DbcStructureDefinition(
  name: 'CreatureFamily',
  format: creatureFamilyFormat,
  fields: [
