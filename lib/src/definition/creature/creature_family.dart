...
final creatureFamily = DbcSchema(
  ...
  fields: [
    ...
    const Field(
      index: 4,
      name: 'MaxScaleLevel',
      description: 'MaxScaleLevel',
      type: FieldType.int32,
    ),
    const Field(
      index: 5,
      name: 'SkillLine0',
      description: 'SkillLine 0',
      type: FieldType.int32,
    ),
    const Field(
      index: 6,
      name: 'SkillLine1',
      description: 'SkillLine 1',
      type: FieldType.int32,
    ),
    const Field(
      index: 7,
      name: 'PetFoodMask',
      description: 'PetFoodMask',
      type: FieldType.int32,
    ),
    const Field(
      index: 8,
      name: 'PetTalentType',
      description: 'PetTalentType',
      type: FieldType.int32,
    ),
    const Field(
      index: 9,
      name: 'CategoryEnumID',
      description: 'CategoryEnumID',
      type: FieldType.int32,
    ),
