/// GameObjectDisplayInfo.dbc - 游戏对象显示信息格式
library;
...
const String gameObjectDisplayInfoFormat = 'nsxxxxxxxxxxffffffx';

/// GameObjectDisplayInfo 结构定义
const DbcStructureDefinition gameObjectDisplayInfo = DbcStructureDefinition(
  name: 'GameObjectDisplayInfo',
  format: gameObjectDisplayInfoFormat,
  fields: [
