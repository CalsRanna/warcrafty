...
final achievementCriteria = DbcSchema(
  ...
  fields: [
    ...
    const Field(
      index: 6,
      name: 'Start_asset',
      description: 'Start_asset',
      type: FieldType.int32,
    ),
    const Field(
      index: 7,
      name: 'Fail_event',
      description: 'Fail_event',
      type: FieldType.int32,
    ),
    const Field(
      index: 8,
      name: 'Fail_asset',
      description: 'Fail_asset',
      type: FieldType.int32,
    ),
    ...
    const Field(
      ...
      description: 'Timer_start_event',
      type: FieldType.int32,
    ),
    const Field(
      index: 28,
      name: 'Timer_asset_ID',
      description: 'Timer_asset_ID',
      type: FieldType.int32,
    ),
    const Field(
      index: 29,
      name: 'Timer_time',
      description: 'Timer_time',
      type: FieldType.int32,
    ),
    const Field(
      index: 30,
      name: 'Ui_order',
      description: 'Ui_order',
      type: FieldType.int32,
    ),
  ],
);
