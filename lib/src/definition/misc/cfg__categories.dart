...
final cfgCategories = DbcStructureDefinition(
  name: 'Cfg_Categories',
  format: 'niiisssssssssssssssss',
  fields: [
    const FieldDefinition(index: 0, name: 'ID', description: 'ID', format: DbcFieldFormat.indexField),
    const FieldDefinition(index: 1, name: 'LocaleMask', description: 'LocaleMask', format: DbcFieldFormat.intType),
    const FieldDefinition(index: 2, name: 'Create_charsetMask', description: 'Create_charsetMask', format: DbcFieldFormat.intType),
